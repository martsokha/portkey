...
Thank you for your interest in contributing to the Portkey Rust SDK! We appreciate your help in making this project better.
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/portkey.git
   cd portkey
   ```
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/martsokha/portkey.git
   ```
